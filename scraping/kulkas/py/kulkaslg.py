...
# Setup
base_url = "https://myhartono.com/find/kulkas+lg"
headers = {
...
for page in range(1, 11):
    ...
    url = f"https://myhartono.com/find/kulkas+lg?page={page}"
...
# Simpan ke CSV
with open("scraping/kulkaslg.csv", "w", newline="", encoding="utf-8") as file:
    writer = csv.writer(file)
    writer.writerow(["Nama Produk", "Harga", "Link", "Gambar"])
    writer.writerows(all_data)

print("[DONE] Selesai! Data disimpan ke kulkaslg.csv")
