...
# Setup
base_url = "https://myhartono.com/find/lenovo"
headers = {
...
for page in range(1, 11):
    ...
    url = f"https://myhartono.com/find/lenovo?page={page}"
...
# Simpan ke CSV
with open("scraping/lenovo.csv", "w", newline="", encoding="utf-8") as file:
    writer = csv.writer(file)
    writer.writerow(["Nama Produk", "Harga", "Link", "Gambar"])
    writer.writerows(all_data)

print("[DONE] Selesai! Data disimpan ke lenovo.csv")
